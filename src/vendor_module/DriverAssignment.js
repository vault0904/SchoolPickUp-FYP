...
import { TrashIcon } from "@heroicons/react/24/solid"
import '../css/defaultstyle.css'
import {pickUpJobsTodayTS1, pickUpJobsTodayTS2} from './ViewVehiclePickUpJobs';
            ...
            {combinedData.length === 0 ? (
              ...
              <table className="w-full min-w-max table-auto text-left">
                ...
                <CModal 
                  ...
                  onClose={() => setShowAssignPickUpJobModal(false)} 
                  style={{marginTop: '40%', marginLeft: '14%'}}>
                  <CModalHeader>
                    <CModalTitle>
                      <div style={{ color: '#56844B', fontWeight: 'bold', fontSize: '20px'}}>Assign Driver (ID: {selectedDriverIdForPickUpJob}) to pick up job</div>
                      <Typography className="pt-2">
                        Jobs remaining for {selectedSchoolIdForPickUpJob} {selectedRegionForPickUpJob} region: {jobsRemaining}
                      </Typography>
                    </CModalTitle>
                  </CModalHeader>
                  <CModalBody>
                  ...
                  <CModalFooter>
                    <div className="gap-2 col-8 mx-auto">
                    <Typography variant="h5">Job assignment summary:</Typography>
                    <Typography variant="h6" className="pt-2">Pick up job for '{selectedSchoolIdForPickUpJob}'</Typography>
                    <Typography className="pt-2">Selected Driver: {selectedDriverIdForPickUpJob}</Typography>
                    <Typography className="pt-2">Selected Vehicle: {selectedVehiclePlateForPickUpJob}</Typography>
                    <Typography className="pt-2">Selected Vehicle's Capacity: {selectedVehicleCapacityForPickUpJob}</Typography>
                    {/* <Typography className="p2-2">Expected number of jobs for {selectedRegionForPickUpJob} region: {jobsForSchoolInRegion}</Typography> */}
